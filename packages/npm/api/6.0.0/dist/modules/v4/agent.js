 ...
 */
export default function agent(ua) {
    if (!ua || typeof ua !== 'string')
        throw new Error('A User-Agent string is required');
    if (ua.length > MAX_STRING_LENGTH)
        throw new Error(`User-Agent must be less than ${MAX_STRING_LENGTH} characters`);
