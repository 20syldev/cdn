...
export const VALID_TIMEZONES = ['UTC', 'America/New_York', 'Europe/Paris', 'Asia/Tokyo', 'Australia/Sydney'];
/**
 ...
 */
export default function time(type = 'live', start, end, format, timezone, target) {
    ...
    if (type === 'countdown') {
        ...
        const direction = targetDate > now ? 'future' : 'past';
